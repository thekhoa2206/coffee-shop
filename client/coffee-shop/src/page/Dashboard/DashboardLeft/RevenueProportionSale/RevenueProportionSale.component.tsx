...
import { formatDateUTC, formatMoney, hasPermission } from "utilities";
...
const RevenueProportionSale = (props: RevenueProportionSaleProps) => {
  ...
  return (
    <Box className={props.classes.root} display="flex" flexWrap="wrap" style={{marginBottom: 50}}>
      <Box style={{ width: "100%" }}>
        <Grid container xs={12}>
          ...
          <Grid container xs={2}>
            <Select
              value={dateRange}
              style={{ height: 36, color: "#182537", marginTop: 20, marginLeft: 30 }}
      ...
      <Box className={classes.root}>
        <Box className="box-content">
          <Box className="box-content-revenue">
            ...
            />
            <Typography style={{ fontWeight: 500, marginLeft: 400, marginTop: 20 }}>
                Tổng doanh thu:{" "}
